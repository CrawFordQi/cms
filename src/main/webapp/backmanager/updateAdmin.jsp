 ...
 <div class="container text-center">
         <table class="table table-hover" id="table1" style="table-layout: fixed;">
	         <c:forEach var="user" begin="0" items="${list}">
	    		...
	    		<tr><td>密&nbsp&nbsp&nbsp&nbsp	码：<input type="text" id="password" name="password" value="${user.password }"/></td></tr>
	    	 	<tr><td><input type="submit" value="修改" onclick="updateAdmin(${user.id})"><a href="managerAdmin.do" >返回</a></td></tr>
	    	 </c:forEach>
         </table>
    </div>
</body>
