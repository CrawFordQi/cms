...
<!-- 中间部分 -->
<div class="container text-center"><font size=4px><b>新闻分类管理</b></font></div>
	<div>
    ...
    <div class="container text-center">
        ...
        <input style='margin-right: 22%;background-color:#00A2CA;' type="submit" value="添加新闻类型"  onclick="addNews_type()"/>
    </div>
<!-- 分页 -->
	<div class="row">
		<ul class="pager">
...
function addNews_type(){
	 window.location.href="addNews_typeA.do";
}
</script>
</html>